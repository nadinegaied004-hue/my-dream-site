                  ...
                  <button
                    ...
                    className={`w-full text-left px-2 py-1.5 rounded text-sm transition-colors ${
                      filterMode === mode.key
                        ...
                        : "hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-pink-400"
                    }`}
                  >
                    {mode.label}
                  </button>
            ...
            <div className="border-t border-gray-300 pt-3">
              {filterMode === "categorie" && (
                <div className="space-y-1">
                  <h4 className="text-xs font-medium text-[#ff69b4] mb-1">Catégories</h4>
                  {categories.map((cat) => (
                    <button
                      key={cat}
              ...
              {filterMode === "evenement" && (
                <div className="space-y-1 mt-3 pt-3 border-t border-gray-200">
                  <h4 className="text-xs font-medium text-[#ff69b4] mb-1">Événements à proximité</h4>
              ...
              {filterMode === "saison" && (
                <div className="space-y-1 mt-3 pt-3 border-t border-gray-200">
                  <h4 className="text-xs font-medium text-[#ff69b4] mb-1">Saisons</h4>
                  {saisons.map((s) => (
                    <button
                      key={s}
              ...
              {filterMode === "attraction" && (
                <div className="space-y-1 mt-3 pt-3 border-t border-gray-200">
                  <h4 className="text-xs font-medium text-[#ff69b4] mb-1">Attractions à proximité</h4>
