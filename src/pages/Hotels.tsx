            ...
            <div className="border-t border-gray-300 pt-3">
              {filterMode === "categorie" && (
                <div className="space-y-1">
                  <h4 className="text-xs font-medium text-pink-400 mb-1">Catégories</h4>
                  {categories.map((cat) => (
                    <button
                      key={cat}
              ...
              {filterMode === "evenement" && (
                <div className="space-y-1 mt-3 pt-3 border-t border-gray-200">
                  <h4 className="text-xs font-medium text-pink-400 mb-1">Événements à proximité</h4>
              ...
              {filterMode === "saison" && (
                <div className="space-y-1 mt-3 pt-3 border-t border-gray-200">
                  <h4 className="text-xs font-medium text-pink-400 mb-1">Saisons</h4>
                  {saisons.map((s) => (
                    <button
                      key={s}
              ...
              {filterMode === "attraction" && (
                <div className="space-y-1 mt-3 pt-3 border-t border-gray-200">
                  <h4 className="text-xs font-medium text-pink-400 mb-1">Attractions à proximité</h4>
